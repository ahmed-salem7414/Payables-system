...
export default function MawridDashboard() {
  ...
  const [printingSupplier, setPrintingSupplier] = useState<Supplier | null>(null);
          ...
          <div className="flex items-center gap-4 self-end md:self-auto no-print">
            ...
            <div className="flex items-center gap-2 bg-slate-100/60 p-1.5 rounded-2xl border border-slate-200/80 shadow-inner">
              ...
              <div className="flex flex-col items-start gap-0.5 px-2 py-0.5">
                ...
                <span className="text-[9px] text-emerald-600 font-sans block leading-none">مزامنة فائقة السرعة</span>
              </div>
                          ...
                          <div className="flex items-start justify-between">
                            ...
                            <div className="flex items-center gap-1 shrink-0">
                              ...
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  setPrintingSupplier(sup);
                                }}
                                className="p-1.5 text-slate-500 hover:text-blue-600 hover:bg-blue-500/10 rounded-lg transition-colors cursor-pointer"
                                title="طباعة بيانات المورد"
                              >
                  ...
                  <div className="flex flex-col gap-1 w-full relative z-[60]">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`bg-slate-50 text-slate-800 border border-slate-200 text-xs px-2.5 py-2.5 ${selectedReportSupplierId !== "all" ? "pl-12" : "pl-8"} rounded-xl focus:ring-1 focus:ring-emerald-500/20 focus:border-emerald-500 font-bold font-sans w-full h-[42px] transition-all text-right`}
                      />
                      ...
                      {selectedReportSupplierId !== "all" && (
                        <button
                          type="button"
                          onMouseDown={(e) => {
                            // Use onMouseDown to prevent blur before click executes
                            e.preventDefault();
                            e.stopPropagation();
                          ...
                          className="absolute left-8 top-[14px] text-slate-400 hover:text-slate-600 font-bold text-xs cursor-pointer select-none z-10"
                          title="مسح الاختيار والرجوع للكل"
                        >
                          ✕
                        </button>
                      )}
            ...
            <div className="bg-white rounded-3xl border-[6px] border-double border-emerald-700/60 p-10 shadow-2xl text-slate-900 printable-report-sheet printable-report-page portrait-preview-page relative overflow-hidden text-right select-none">
              ...
              <div className="relative z-10 space-y-6 flex flex-col justify-between h-full">
                ...
                <div>
                  <div className="border-b-2 border-emerald-600 pb-4 flex flex-row items-center justify-between gap-4 w-full">
                    <div className="text-right">
                      ...
                      <p className="text-[10px] text-emerald-800 font-bold font-sans mt-0.5">
                        إدارة الحسابات العامة وشؤون الموردين • بطاقة تعريف المورد والتحويلات البنكية
                      </p>
                      <p className="text-[10px] text-slate-500 font-semibold font-sans mt-0.5">
                        جهة التوثيق: مكتب مراجعة شؤون المدفوعات والتعاقدات
                      </p>
                    ...
                    <div className="text-left flex flex-row items-center gap-6">
                      <div className="flex flex-col items-center justify-center gap-1 bg-slate-50 p-2 rounded-xl border border-slate-200/50">
                        ...
                        <span className="text-[7px] font-mono tracking-widest text-slate-500">MCH-SUP-{printingSupplier.id.substring(0, 6).toUpperCase()}-AUTH</span>
                      </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-6 text-xs font-sans">
                    <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
                      <span className="text-slate-500 block mb-1 font-semibold">مسؤول الاتصال الرئيسي</span>
                      <strong className="text-slate-800">{printingSupplier.name}</strong>
                    </div>
                    <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
                      <span className="text-slate-500 block mb-1 font-semibold">تاريخ التسجيل بالمنظومة الإلكترونية</span>
                      <strong className="font-mono text-slate-800">
                        {new Date(printingSupplier.createdAt).toLocaleDateString("ar-EG", {
                          year: "numeric",
                          month: "long",
                          day: "numeric",
                        })}
                  ...
                  <div className="grid grid-cols-2 gap-6 text-xs font-sans">
                    <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
                      <span className="text-slate-500 block mb-1 font-semibold">رقم الهاتف والاتصال</span>
                      <strong className="text-slate-800 font-mono">{printingSupplier.phone || "—"}</strong>
                    </div>
                    <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
                      <span className="text-slate-500 block mb-1 font-semibold">البريد الإلكتروني للتعاملات</span>
                  ...
                  <div className="bg-slate-50/50 rounded-2xl p-5 border border-slate-100 space-y-4 text-xs font-sans">
                    <div className="grid grid-cols-3 gap-4">
                      <div className="col-span-1 text-slate-500 font-semibold flex items-center">الاسم المعتمد للحساب البنكي:</div>
                      <div className="col-span-2 font-bold text-slate-900 bg-white p-2.5 rounded-lg border border-slate-200/60 text-sm">
                        {printingSupplier.bankAccountName || "—"}
                      </div>
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                      <div className="col-span-1 text-slate-500 font-semibold flex items-center">رقم الحساب أو الآيبان (IBAN):</div>
                      <div className="col-span-2 font-mono font-bold text-slate-900 bg-emerald-50/25 p-2.5 rounded-lg border border-emerald-100 text-right select-all text-sm">
                        {printingSupplier.bankAccount || "—"}
                      </div>
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                      <div className="col-span-1 text-slate-500 font-semibold flex items-center">رمز السويفت كود (SWIFT CODE):</div>
                      <div className="col-span-2 font-mono font-bold text-slate-900 bg-white p-2.5 rounded-lg border border-slate-200/60 text-sm">
                        {printingSupplier.swiftCode || "—"}
                      </div>
                    </div>
                  </div>
                </div>
