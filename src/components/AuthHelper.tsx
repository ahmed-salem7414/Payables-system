...
export default function AuthHelper() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col items-center justify-center p-4 md:p-6 text-right font-sans selection:bg-emerald-500/20" dir="rtl">
      ...
      <div className={`w-full max-w-2xl bg-white border border-slate-200 p-6 md:p-8 rounded-3xl shadow-2xl relative z-10 backdrop-blur-md space-y-6 transition-all duration-300`}>
        ...
        <div className="flex justify-center">
          <div className="relative">
            ...
            <div className="relative bg-slate-100 border border-slate-200 p-5 rounded-2xl flex items-center justify-center">
        ...
        <div className="text-center space-y-2">
          <span className="text-[10px] font-bold tracking-widest text-emerald-600 uppercase bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1 rounded-full">بوابة تفعيل ومزامنة مَورِد</span>
        ...
        {success ? (
          <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-2xl p-6 text-center space-y-3 animate-fadeIn">
            ...
            <p className="text-base font-bold text-emerald-700">تم تسجيل الدخول والربط بنجاح تام!</p>
            <p className="text-xs text-slate-700 font-mono select-all break-all bg-emerald-50 border border-emerald-200/60 py-2 px-4 rounded-xl border border-emerald-500/20 max-w-md mx-auto">
              {userEmail}
            </p>
            <p className="text-xs text-slate-500">يجري حفظ ترخيص المزامنة وإغلاق هذا الإقران تلقائياً...</p>
          </div>
        ) : (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="bg-rose-500/10 border border-rose-500/20 rounded-2xl p-4 md:p-5 space-y-3.5">
              <div className="flex items-center gap-2 border-b border-rose-500/10 pb-2">
                ...
                <h3 className="font-extrabold text-sm text-rose-700">⚠️ تنبيه أمني هام جداً (تجنّب الخطأ الشائع):</h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
                <div className="bg-slate-50/40 border border-rose-500/20 p-3 rounded-xl space-y-1.5">
                  <div className="flex items-center gap-1.5 text-rose-600 font-bold text-xs">
                    <XCircle className="w-4 h-4" />
                    <span>❌ أمثلة خاطئة (تجنبها تماماً):</span>
                  </div>
                  <ul className="text-[11px] text-slate-500 space-y-1 font-mono break-all list-disc list-inside text-left">
                ...
                <div className="bg-emerald-500/5 border border-emerald-500/20 p-3 rounded-xl space-y-1.5">
                  ...
                  <ul className="text-[11px] text-slate-800 space-y-1 font-mono break-all list-disc list-inside text-left">
                    <li>{devDomain}</li>
                    <li>{preDomain}</li>
                  </ul>
                </div>
            ...
            {/* Quick Steps */}
            <div className="bg-slate-100/90 border border-slate-200 rounded-2xl p-4 md:p-5 text-xs text-slate-700 space-y-3.5">
              <h3 className="font-bold text-slate-900 text-sm border-b border-slate-200/80 pb-2 flex items-center gap-2">
              ...
              <ol className="list-decimal list-inside space-y-2 leading-relaxed text-right text-slate-700">
                ...
                <li>
                  من القائمة الجانبية للإعدادات، اختر <span className="text-slate-900 font-bold">Authorized domains</span>.
                </li>
                <li>
                  اضغط على زر <span className="text-emerald-600 font-bold">Add domain (إضافة نطاق)</span> وألصق النطاقين التاليين (انسخ واحداً تلو الآخر عبر الأزرار):
                </li>
              </ol>
              ...
              <div className="space-y-2 pt-2">
                {/* Dev domain */}
                <div className="flex items-center justify-between bg-slate-50/90 border border-slate-200 p-2.5 rounded-xl">
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 px-1.5 py-0.5 rounded font-mono">1</span>
                    <span className="font-mono text-[11px] select-all break-all text-slate-800">{devDomain}</span>
                  </div>
                  <button 
                    onClick={() => copyToClipboard(devDomain)}
                    className="p-1.5 bg-slate-100 border border-slate-200 hover:bg-slate-800 text-slate-700 hover:text-emerald-600 rounded-lg transition-all cursor-pointer flex items-center gap-1"
                    title="نسخ النطاق"
                  >
                ...
                <div className="flex items-center justify-between bg-slate-50/90 border border-slate-200 p-2.5 rounded-xl">
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 px-1.5 py-0.5 rounded font-mono">2</span>
                    <span className="font-mono text-[11px] select-all break-all text-slate-800">{preDomain}</span>
                  </div>
                  <button 
            ...
            <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-4 md:p-5 space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-extrabold text-sm text-emerald-700">💡 حل مشكلة التخزين المؤقت (الحل السحري الفوري):</h4>
              </div>
              <p className="text-xs text-slate-700 leading-relaxed">
              ...
              <div className="bg-slate-50 border border-slate-200/60 p-3.5 rounded-xl border border-emerald-500/10 space-y-2">
                <p className="text-xs font-bold text-slate-900">افتح صفحة البرنامج في وضع التصفح المتخفي (Incognito / Private Window):</p>
                <div className="text-[11px] text-slate-500 space-y-1.5 leading-relaxed">
                  <p>1. انسخ رابط صفحة "مورِد" الرئيسية في متصفحك.</p>
                  <p>2. افتح نافذة تصفح متخفية جديدة (افتح القائمة واضغط على <span className="text-emerald-700 font-bold">New Incognito Window</span>).</p>
              ...
              <div className="pt-1 flex justify-end">
                <button
                  ...
                  disabled={loading}
                  className="flex items-center gap-1.5 bg-slate-100 hover:bg-slate-800 border border-slate-700 hover:border-slate-600 text-slate-700 text-[11px] py-1.5 px-3 rounded-lg transition-colors cursor-pointer"
                >
            ...
            <div className="bg-slate-100/60 border border-slate-200 rounded-2xl p-4 md:p-5 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-200 pb-2">
                <div className="flex items-center gap-2">
                  <ShieldCheck className="w-5 h-5 text-indigo-600 shrink-0" />
                  <h4 className="font-extrabold text-sm text-indigo-700">هل تواجه خطأ النطاق غير المصرح به بالرغم من إضافته؟</h4>
                </div>
                <button
                  onClick={() => setShowConfigEditor(!showConfigEditor)}
                  className="text-[11px] bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-700 border border-indigo-500/20 px-2.5 py-1 rounded-lg transition-colors cursor-pointer"
                >
              ...
              {showConfigEditor && (
                <div className="space-y-3.5 animate-fadeIn">
                  <p className="text-xs text-slate-700 leading-relaxed">
                    يستخدم هذا التطبيق حالياً معرّف مشروع افتراضي هو: <span className="font-mono font-bold text-emerald-600 bg-emerald-500/5 px-1.5 py-0.5 rounded border border-emerald-500/10">{activeFirebaseConfig.projectId}</span>.
                    <br />
                  ...
                  <div className="bg-slate-950/80 p-3.5 rounded-xl border border-indigo-500/10 space-y-3">
                    <div className="bg-[#0c162d] border border-slate-200 p-4 rounded-xl space-y-4 font-sans text-xs">
                      <span className="font-bold text-emerald-600 block border-b border-slate-200 pb-2">📂 دليل خطوة بخطوة بالصور التعبيرية للوصول للكود:</span>
                      
                      <div className="space-y-3 leading-relaxed text-slate-700">
                        <div className="flex gap-2 items-start">
                          <span className="w-5 h-5 rounded-full bg-emerald-500/15 text-emerald-600 border border-emerald-500/30 flex items-center justify-center font-bold font-mono text-[11px] shrink-0">1</span>
                          <p>
                            افتح منصة <a href="https://console.firebase.google.com/" target="_blank" rel="noreferrer" className="text-emerald-600 font-bold underline hover:text-emerald-700">Firebase Console ↗</a> واضغط على <strong>مشروعك</strong>.
                          </p>
                        </div>

                        <div className="flex gap-2 items-start">
                          <span className="w-5 h-5 rounded-full bg-emerald-500/15 text-emerald-600 border border-emerald-500/30 flex items-center justify-center font-bold font-mono text-[11px] shrink-0">2</span>
                          <p>
                        ...
                        <div className="flex gap-2 items-start">
                          <span className="w-5 h-5 rounded-full bg-emerald-500/15 text-emerald-600 border border-emerald-500/30 flex items-center justify-center font-bold font-mono text-[11px] shrink-0">3</span>
                          <div>
                            <p>
                            ...
                            <div className="mt-2 p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl text-[11px] text-amber-750 space-y-1.5 list-none font-sans">
                              ...
                              <ul className="list-decimal list-inside space-y-1 pr-1 text-slate-600">
                                <li>اضغط على أيقونة <strong>الويب <code className="bg-slate-100 px-1.5 py-0.5 rounded text-emerald-600 font-mono font-bold">&lt;/&gt;</code></strong> (الدائرة الثالثة في المنتصف التي تظهر في الصورة لديك).</li>
                                <li>اكتب اسماً لتطبيقك الجديد (مثلاً: <code className="bg-slate-100 px-1.5 py-0.5 rounded text-pink-400 font-mono">mawrid-app</code>) ثم اضغط على زر <strong>Register app</strong> الأزرق.</li>
                        ...
                        <div className="flex gap-2 items-start">
                          <span className="w-5 h-5 rounded-full bg-emerald-500/15 text-emerald-600 border border-emerald-500/30 flex items-center justify-center font-bold font-mono text-[11px] shrink-0">4</span>
                          <p>
                        ...
                        <div className="bg-slate-950/60 p-3 rounded-lg border border-slate-200 font-mono text-[11px] text-slate-500 space-y-1 block max-w-full overflow-x-auto text-left" dir="ltr">
                          <p className="text-slate-500">// انسخ الكود الذي يشبه هذا وضعه في المربع بالأسفل:</p>
                          <p><span className="text-emerald-600">const</span> <span className="text-pink-400">firebaseConfig</span> = {"{"}</p>
                          <p>&nbsp;&nbsp;apiKey: <span className="text-emerald-600">"AIzaSy..."</span>,</p>
                          <p>&nbsp;&nbsp;authDomain: <span className="text-emerald-600">"..."</span>,</p>
                          <p>&nbsp;&nbsp;projectId: <span className="text-emerald-600">"..."</span>,</p>
                          <p>&nbsp;&nbsp;storageBucket: <span className="text-emerald-600">"..."</span>,</p>
                          <p>&nbsp;&nbsp;appId: <span className="text-emerald-600">"..."</span></p>
                          <p>{"};"}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2 pt-2">
                      <label className="block text-xs font-black text-emerald-600 flex items-center gap-1.5">
                        <span>✍️ ألصق الكود المنسوخ هنا في هذا المربع (المستطيل):</span>
                      </label>
                      <textarea
                        rows={7}
                        dir="ltr"
                        className="w-full bg-slate-100 border-2 border-emerald-500/50 rounded-xl p-3 text-xs font-mono text-slate-900 placeholder-slate-500 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-500/30 focus:outline-none text-left"
                        placeholder={`ألصق الكود هنا، مثال:
{
  ...
  "appId": "..."
                    ...
                    {configError && (
                      <p className="text-xs text-rose-600 font-bold">{configError}</p>
                    )}

                    <div className="flex gap-2 pt-1.5">
                      <button
                        onClick={handleSaveCustomConfig}
                        className="flex-grow bg-indigo-600 hover:bg-indigo-500 text-slate-900 text-xs font-bold py-2 px-4 rounded-lg transition-colors cursor-pointer"
                      >
                      ...
                      {isCustomConfigActive && (
                        <button
                          ...
                          className="bg-rose-500/10 hover:bg-rose-500/20 text-rose-700 border border-rose-500/20 text-xs font-bold py-2 px-3 rounded-lg transition-colors cursor-pointer"
                        >
            ...
            {error && error !== "unauthorized-domain" && (
              <div className="space-y-4">
                <div className="bg-rose-500/10 border border-rose-500/30 rounded-2xl p-4 text-xs text-rose-700 space-y-1">
                  <p className="font-bold text-rose-600">حدث خطأ آخر أثناء تسجيل الدخول:</p>
                ...
                {String(error).toLowerCase().includes("configuration-not-found") && (
                  <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-4 md:p-5 space-y-4 text-right" dir="rtl">
                    <div className="flex items-center gap-2 border-b border-amber-500/20 pb-2">
                      ...
                      <h4 className="font-extrabold text-sm text-amber-750">💡 الحل الفوري لخطأ "Configuration-not-found":</h4>
                    </div>
                    ...
                    <div className="space-y-3 leading-relaxed text-[11px] text-slate-700">
                      <div className="flex gap-2 items-start">
                        <span className="w-4 h-4 rounded-full bg-amber-500/15 text-amber-750 border border-amber-500/30 flex items-center justify-center font-bold font-mono shrink-0">1</span>
                        <p>
                          افتح منصة <a href="https://console.firebase.google.com/" target="_blank" rel="noreferrer" className="text-emerald-600 font-bold underline hover:text-emerald-700">Firebase Console ↗</a> واضغط على مشروعك.
                        </p>
                      </div>

                      <div className="flex gap-2 items-start">
                        <span className="w-4 h-4 rounded-full bg-amber-500/15 text-amber-750 border border-amber-500/30 flex items-center justify-center font-bold font-mono shrink-0">2</span>
                        <p>
                      ...
                      <div className="flex gap-2 items-start">
                        <span className="w-4 h-4 rounded-full bg-amber-500/15 text-amber-750 border border-amber-500/30 flex items-center justify-center font-bold font-mono shrink-0">3</span>
                        <p>
                      ...
                      <div className="flex gap-2 items-start">
                        <span className="w-4 h-4 rounded-full bg-amber-500/15 text-amber-750 border border-amber-500/30 flex items-center justify-center font-bold font-mono shrink-0">4</span>
                        <p>
                      ...
                      <div className="flex gap-2 items-start">
                        <span className="w-4 h-4 rounded-full bg-amber-500/15 text-amber-750 border border-amber-500/30 flex items-center justify-center font-bold font-mono shrink-0">5</span>
                        <p>
                    ...
                    <p className="text-[11px] text-emerald-600 bg-emerald-500/5 p-2 rounded-lg border border-emerald-500/10 font-bold text-center">
            ...
            <div className="pt-2 space-y-3">
              <div className="text-center">
                <p className="text-[11px] text-slate-500 font-semibold mb-2 flex items-center justify-center gap-1.5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <button
                  ...
                  className="w-full flex flex-col items-center justify-center gap-1 bg-gradient-to-br from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 font-extrabold pb-0.5 active:scale-[0.98] text-slate-900 font-extrabold py-3.5 px-6 rounded-2xl shadow-lg transition-all duration-200 cursor-pointer text-xs"
                >
                ...
                <button
                  ...
                  className="w-full flex flex-col items-center justify-center gap-1 bg-gradient-to-br from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 active:scale-[0.98] text-slate-900 font-extrabold py-3.5 px-6 rounded-2xl shadow-lg transition-all duration-200 cursor-pointer text-xs"
                >
